...
- 用新版整理规则重写 [[控制论式系统思维]]，把原先偏提纲式的 `seed` 主题页改成更强调局部组织、正文自解释和就地链接的写法
- 新增概念页 [[反馈回路]]、[[可观测性]]、[[可控制性]]，把控制论主线里最容易卡住的三个概念正式接入知识网络
- 回写 [[工程控制论（第三版）]] 的相关概念与关系，并同步更新概念索引、主题索引、待处理和总览，让这组材料从“只有主题骨架”进入“主题 + 概念”状态
